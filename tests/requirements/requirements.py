...
class Requirements(object):
    """
    Checks if test cases meet their specified requirements. 
    Test scripts can contain a line starting with 
    #requires or #Requires, optionally followed by a colon,
    then a Python expression which combines boolean values.
