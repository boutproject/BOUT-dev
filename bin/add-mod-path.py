...
def writeable_dir(prospective_dir):
    ...
    if os.access(prospective_dir, os.W_OK):
        ...
        raise Exception(
            "readable_dir:{0} is not a writeable dir".format(prospective_dir))
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description=_info,
    ...
    parser.add_argument('--name', '-n', nargs=1,
                        ...
                        bout++/3d-metrics`.''')
    parser.add_argument('--bout-top', '-t', nargs=1,
                        help="""bout-top is the root directory of the BOUT++ installation. Note that
