...
\end{align*}
%
where $F=\Bt R$ is a function only of $\psi$ (sometimes called the 
...
\subsection{\texorpdfstring{$\psi$}{psi} derivative of the 
	    \texorpdfstring{$B$}{B} field}
...
\zeta\right)$}{(psi, theta, zeta)} flux coordinates}
