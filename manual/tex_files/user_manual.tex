...
Arakawa scheme, $y$-derivatives are neglected.  An example of usage of the
brackets can be found in for example \file{examples/MMS/advection} or
\file{examples/blob2d}.
