...
\emph{Important note:} The boundary conditions are currently not set in the
corner cells. Therefore: When using stecils which uses corner cells (like the
Arakawa scheme) care must be taken, and the boundary conditions in the corner
cells must be set manually.
