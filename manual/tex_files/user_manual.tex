...
found in the downloaded \verb@.tar.gz@, but we will provide a step-by-step
...
move the downloaded \verb@.tar.gz@
...
\subsection{PETSc with SUNDIALS}
%
FIXME: YOU ARE HERE
PETSc can be built with SUNDIALS (see section \ref{sec:sundials} for).
