...
%
A backward compatible method to set initial value is to specify the function for each dimension separately using
...
\end{lstlisting}
%
To apply the ballooning transform to these initial conditions there is a global flag ``ballooning'' which should be set to true.
%
