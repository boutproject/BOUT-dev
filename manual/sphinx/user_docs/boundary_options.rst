...
possible values are ``parallel_dirichlet_o1``,
``parallel_dirichlet_o2``, ``parallel_dirichlet_o3``
and ``parallel_neumann_o1``, ``parallel_neumann_o2``,
``parallel_neumann_o3``. The stencils used are the same as for the
