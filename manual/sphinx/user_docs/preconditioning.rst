...
.. math:: \ensuremath{\frac{\partial \ensuremath{\mathbf{f}}}{\partial t}} = \ensuremath{\mathbf{F}}\left(\ensuremath{\mathbf{f}}\right)
...
.. math:: \ensuremath{\mathbb{J}}= \ensuremath{\frac{\partial \ensuremath{\mathbf{F}}}{\partial \ensuremath{\mathbf{f}}}}

The order of the elements in the vector :math:`\ensuremath{\mathbf{f}}`
...
#. Calculate the non-zero elements of :math:`\ensuremath{\mathbb{J}}`
...
.. math::
   ...
   \begin{aligned}
   \ensuremath{\frac{\partial N_i}{\partial t}} + \ensuremath{\ensuremath{\mathbf{v}}_E}\cdot\nabla N_i &=& 0 \\
   \ensuremath{\frac{\partial \omega}{\partial t}} + \ensuremath{\ensuremath{\mathbf{v}}_E}\cdot\nabla\omega &=& 2\omega_{ci}\ensuremath{\mathbf{b}}\times\kappa\cdot\nabla P + N_iZ_i e\frac{4\pi V_A^2}{c^2}\nabla_{||}j_{||} \\
...
.. math::
   ...
   \ensuremath{\mathbf{f}} = \left(\begin{array}{c}
   P \\
   \psi \\
   U
   \end{array}\right)
...
.. math::
   ...
   \begin{aligned}
     \ensuremath{\frac{\partial \psi}{\partial t}} &=& -\frac{1}{B_0}\nabla_{||}\phi \\
     &=& -\frac{1}{B_0}\left[\ensuremath{\mathbf{b}}_0 - \left(\ensuremath{\mathbf{b}}_0\times\nabla\psi\right)\right]\cdot\nabla\phi \\
     &=& -\frac{1}{B_0}\ensuremath{\mathbf{b}}_0\cdot\nabla\phi - \frac{1}{B_0}\left(\ensuremath{\mathbf{b}}_0\times\nabla\phi\right)\cdot\nabla\psi \\
   \Rightarrow \frac{d \psi}{dt} &=& -\frac{1}{B_0}\ensuremath{\mathbf{b}}_0\cdot\nabla \phi\end{aligned}
...
.. math::
   ...
   \begin{aligned}
   \frac{1}{B_0}\nabla_\perp^2\phi &=& U \\
   \left(\ensuremath{\frac{\partial }{\partial t}} + \ensuremath{\mathbf{v}}_E\cdot\nabla\right)\psi &=& -\frac{1}{B_0}\ensuremath{\mathbf{b}}_0\cdot\nabla\phi \\
   \left(\ensuremath{\frac{\partial }{\partial t}} + \ensuremath{\mathbf{v}}_E\cdot\nabla\right)P &=& 0 \\
   \left(\ensuremath{\frac{\partial }{\partial t}} + \ensuremath{\mathbf{v}}_E\cdot\nabla\right)U &=& \frac{1}{\rho}B_0^2\left[\ensuremath{\mathbf{b}}_0 - \left(\ensuremath{\mathbf{b}}_0\times\nabla\psi\right)\right]\cdot\left(\frac{J_{||0}}{B_0} - \frac{1}{\mu_0}\nabla_\perp^2\psi\right) \nonumber \\
   &+& \frac{1}{\rho}\ensuremath{\mathbf{b}}_0\times\ensuremath{\mathbf{\kappa}}_0\cdot\nabla P \\
   \ensuremath{\mathbf{v}}_E &=& \frac{1}{B_0}\ensuremath{\mathbf{b}}_0\times\nabla\phi\end{aligned}
...
.. math::
   ...
   \color{blue}{-\ensuremath{\mathbf{v}}_E\cdot\nabla} & 0 & \left[\ensuremath{\mathbf{b}}_0\times\nabla\left(P_0 + \color{blue}{P}\right)\cdot\nabla\right]\nabla_\perp^{-2} \\
   \hline
   0 & \color{blue}{-\ensuremath{\mathbf{v}}_E\cdot\nabla} & \left(\ensuremath{\mathbf{b}}_0\cdot\nabla\right)\nabla_\perp^{-2}  \\
   \hline
   2\ensuremath{\mathbf{b}}_0\times\ensuremath{\mathbf{\kappa}}_0\cdot\nabla& -\frac{B_0^2}{\mu_0\rho}\left(\ensuremath{\mathbf{b}}_0 \color{blue}{-\ensuremath{\mathbf{b}}_0\times\nabla\psi}\right)\cdot\nabla\nabla_\perp^2& \color{blue}{-\ensuremath{\mathbf{v}}_E\cdot\nabla} \\
    & + \frac{B_0^2}{\rho}\left[\ensuremath{\mathbf{b}}_0\times\nabla\left(\frac{J_{||0}}{B_0}\right)\right]\cdot\nabla & \\
    & + \color{blue}{\frac{B_0^2}{\mu_0\rho}\nabla\left(\nabla_\perp^2\psi\right)\cdot\left(\ensuremath{\mathbf{b}}_0\times\nabla\right)} & 
   \end{array}\right]
...
points in an X-Z plane. The way to make :math:`\ensuremath{\mathbb{J}}`
...
.. math::
   ...
   \begin{aligned}
   \ensuremath{\frac{\partial N_i}{\partial t}} + \ensuremath{V_{||}}\partial_{||}N_i &=& -N_i\nabla_{||}\ensuremath{V_{||}}+\nabla_\psi\left(D_\perp \partial_\psi N_i\right) \\
   \ensuremath{\frac{\partial \left(N_i\ensuremath{V_{||}}\right)}{\partial t}} + \ensuremath{V_{||}}\partial_{||}\left(N_i\ensuremath{V_{||}}\right) &=& -\partial_{||}P + \nabla_\psi\left(N_i\mu_\perp\partial_\psi\ensuremath{V_{||}}\right) \\
   \frac{3}{2}\ensuremath{\frac{\partial }{\partial t}}\left(N_iT_e\right) &=& \nabla_{||}\left(\kappa_e\partial_{||}T_e\right) + \nabla_\psi\left(N_i\chi_\perp\partial_\perp T_e\right) \\
   \frac{3}{2}\ensuremath{\frac{\partial }{\partial t}}\left(N_iT_i\right) &=& \nabla_{||}\left(\kappa_i\partial_{||}T_i\right) + \nabla_\psi\left(N_i\chi_\perp\partial_\perp T_i\right)\end{aligned}
...
.. math::
   ...
   \left( \begin{array}{c|c|c|c}
     -\ensuremath{V_{||}}\partial_{||} - \nabla_{||}\ensuremath{V_{||}}+ \nabla_\psi D_\perp\partial_\psi & -\partial_{||}N_i - N_i\nabla_{||} & 0 & 0 \\
   -\frac{1}{N_i}\ensuremath{\frac{\partial \ensuremath{V_{||}}}{\partial t}} - \frac{1}{N_i}\ensuremath{V_{||}}\ensuremath{\mathbb{J}}_{N_iN_i} & & &
   \end{array}\right)
...
.. math:: \mathbb{D} = \mathbb{I} \color{blue}{+ \gamma\ensuremath{\mathbf{v}}_E\cdot\nabla}
...
.. math::
   ...
   \mathbb{D}^{-1} \simeq \mathbb{I} \color{blue}{- \gamma\ensuremath{\mathbf{v}}_E\cdot\nabla}
   \label{eq:dapprox}
...
.. math::
   ...
   \begin{aligned}
   \mathbb{P}_{Schur} &\simeq& \mathbb{I} + \gamma^2 \frac{B_0^2}{\mu_0\rho}\left(\ensuremath{\mathbf{b}}_0\cdot\nabla\right)\nabla_\perp^2\left(\ensuremath{\mathbf{b}}_0\cdot\nabla\right)\nabla_\perp^{-2} \nonumber \\
   &\simeq& \mathbb{I} + \gamma^2 V_A^2 \left(\ensuremath{\mathbf{b}}_0\cdot\nabla\right)^2\end{aligned}
...
that row of :math:`\ensuremath{\mathbb{J}}` and the constant: result =
