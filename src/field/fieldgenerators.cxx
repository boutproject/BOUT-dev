...
//////////////////////////////////////////////////////////
// Python
FieldGeneratorPtr FieldPython::clone(const std::list<FieldGeneratorPtr> args) {
  // Call the constructor
  return std::make_shared<FieldPython>(args.front());
}
...
BoutReal FieldPython::generate(double x, double y, double z, double t) {
  py::scoped_interpreter guard{};  
  // Evaluate in scope of main module
  py::object scope = py::module::import("__main__").attr("__dict__");

  auto kwargs = py::dict("x"_a=x,
                         "y"_a=y,
                         "z"_a=z,
                         "t"_a=t
                         );
  ...
  auto message = "{func}"_s.format(**py::dict("func"_a=(*gen).str()));
  auto result = py::eval(message.format(**kwargs), scope).template cast<BoutReal>();
