...
void autogen_Field3D_Field3D_Field3D_mul(  BoutReal * __restrict__ result , const BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int max ){
  for (int i=0;i<max;++i){
...
Field3D operator*(const Field3D & lhs,const Field3D & rhs){
  ...
  if (lhs.getLocation() != rhs.getLocation()){
    throw BoutException("Trying to mul fields of different locations. lhs is at %s, rhs is at %s!",strLocation(lhs.getLocation()),strLocation(rhs.getLocation()));
  }
#endif
...
void autogen_Field3D_Field3D_Field3D_div(  BoutReal * __restrict__ result , const BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int max ){
  for (int i=0;i<max;++i){
    result[i]=lhs [i] /rhs [i] ;
  }
}
...
#if CHECK > 0
  if (lhs.getLocation() != rhs.getLocation()){
    throw BoutException("Trying to div fields of different locations. lhs is at %s, rhs is at %s!",strLocation(lhs.getLocation()),strLocation(rhs.getLocation()));
  }
#endif
  result.setLocation(rhs.getLocation());
  checkData(result);
...
void autogen_Field3D_Field3D_Field3D_plus(  BoutReal * __restrict__ result , const BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int max ){
  for (int i=0;i<max;++i){
    result[i]=lhs [i] +rhs [i] ;
  }
}
...
#if CHECK > 0
  if (lhs.getLocation() != rhs.getLocation()){
    throw BoutException("Trying to plus fields of different locations. lhs is at %s, rhs is at %s!",strLocation(lhs.getLocation()),strLocation(rhs.getLocation()));
  }
#endif
  result.setLocation(rhs.getLocation());
  checkData(result);
...
void autogen_Field3D_Field3D_Field3D_minus(  BoutReal * __restrict__ result , const BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int max ){
  for (int i=0;i<max;++i){
    result[i]=lhs [i] -rhs [i] ;
  }
}
...
#if CHECK > 0
  if (lhs.getLocation() != rhs.getLocation()){
    throw BoutException("Trying to minus fields of different locations. lhs is at %s, rhs is at %s!",strLocation(lhs.getLocation()),strLocation(rhs.getLocation()));
  }
#endif
  result.setLocation(rhs.getLocation());
  checkData(result);
...
void autogen_Field3D_Field3D_Field2D_mul(  BoutReal * __restrict__ result , const BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int nx , int ny , int nz ){
  for (int x=0;x<nx;++x){
  for (int y=0;y<ny;++y){
  for (int z=0;z<nz;++z){
...
Field3D operator*(const Field3D & lhs,const Field2D & rhs){
  ...
  checkData(lhs);
  checkData(rhs);
  autogen_Field3D_Field3D_Field2D_mul( &result[i], &lhs[i], &rhs[i], 
               msh->LocalNx , msh->LocalNy , msh->LocalNz );
...
void autogen_Field3D_Field3D_Field2D_div(  BoutReal * __restrict__ result , const BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int nx , int ny , int nz ){
  for (int x=0;x<nx;++x){
  for (int y=0;y<ny;++y){
  for (int z=0;z<nz;++z){
       result[z+nz*(y+ny*x)] = lhs[z+nz*(y+ny*x)] / rhs[y+x*ny] ;
...
Field3D operator/(const Field3D & lhs,const Field2D & rhs){
  ...
  checkData(lhs);
  checkData(rhs);
  autogen_Field3D_Field3D_Field2D_div( &result[i], &lhs[i], &rhs[i], 
               msh->LocalNx , msh->LocalNy , msh->LocalNz );
  result.setLocation(lhs.getLocation());
  checkData(result);
  return result;
...
void autogen_Field3D_Field3D_Field2D_plus(  BoutReal * __restrict__ result , const BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int nx , int ny , int nz ){
  for (int x=0;x<nx;++x){
  for (int y=0;y<ny;++y){
  for (int z=0;z<nz;++z){
       result[z+nz*(y+ny*x)] = lhs[z+nz*(y+ny*x)] + rhs[y+x*ny] ;
...
Field3D operator+(const Field3D & lhs,const Field2D & rhs){
  ...
  checkData(lhs);
  checkData(rhs);
  autogen_Field3D_Field3D_Field2D_plus( &result[i], &lhs[i], &rhs[i], 
               msh->LocalNx , msh->LocalNy , msh->LocalNz );
  result.setLocation(lhs.getLocation());
  checkData(result);
  return result;
...
void autogen_Field3D_Field3D_Field2D_minus(  BoutReal * __restrict__ result , const BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int nx , int ny , int nz ){
  for (int x=0;x<nx;++x){
  for (int y=0;y<ny;++y){
  for (int z=0;z<nz;++z){
       result[z+nz*(y+ny*x)] = lhs[z+nz*(y+ny*x)] - rhs[y+x*ny] ;
...
Field3D operator-(const Field3D & lhs,const Field2D & rhs){
  ...
  checkData(lhs);
  checkData(rhs);
  autogen_Field3D_Field3D_Field2D_minus( &result[i], &lhs[i], &rhs[i], 
               msh->LocalNx , msh->LocalNy , msh->LocalNz );
  result.setLocation(lhs.getLocation());
  checkData(result);
  return result;
...
void autogen_Field3D_Field3D_BoutReal_mul(  BoutReal * __restrict__ result , const BoutReal * __restrict__ lhs , const BoutReal rhs ,  int max ){
  for (int i=0;i<max;++i){
    result[i]=lhs [i] *rhs ;
  }
}
...
void autogen_Field3D_Field3D_BoutReal_div(  BoutReal * __restrict__ result , const BoutReal * __restrict__ lhs , const BoutReal rhs ,  int max ){
  for (int i=0;i<max;++i){
    result[i]=lhs [i] /rhs ;
  }
}
...
void autogen_Field3D_Field3D_BoutReal_plus(  BoutReal * __restrict__ result , const BoutReal * __restrict__ lhs , const BoutReal rhs ,  int max ){
  for (int i=0;i<max;++i){
    result[i]=lhs [i] +rhs ;
  }
}
...
void autogen_Field3D_Field3D_BoutReal_minus(  BoutReal * __restrict__ result , const BoutReal * __restrict__ lhs , const BoutReal rhs ,  int max ){
  for (int i=0;i<max;++i){
    result[i]=lhs [i] -rhs ;
  }
}
...
void autogen_Field3D_Field2D_Field3D_mul(  BoutReal * __restrict__ result , const BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int nx , int ny , int nz ){
  for (int x=0;x<nx;++x){
  for (int y=0;y<ny;++y){
  for (int z=0;z<nz;++z){
...
Field3D operator*(const Field2D & lhs,const Field3D & rhs){
  ...
  checkData(lhs);
  checkData(rhs);
  autogen_Field3D_Field2D_Field3D_mul( &result[i], &lhs[i], &rhs[i], 
               msh->LocalNx , msh->LocalNy , msh->LocalNz );
  result.setLocation(rhs.getLocation());
  checkData(result);
  return result;
...
void autogen_Field3D_Field2D_Field3D_div(  BoutReal * __restrict__ result , const BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int nx , int ny , int nz ){
  for (int x=0;x<nx;++x){
  for (int y=0;y<ny;++y){
  for (int z=0;z<nz;++z){
       result[z+nz*(y+ny*x)] = lhs[y+x*ny] / rhs[z+nz*(y+ny*x)] ;
...
Field3D operator/(const Field2D & lhs,const Field3D & rhs){
  ...
  checkData(lhs);
  checkData(rhs);
  autogen_Field3D_Field2D_Field3D_div( &result[i], &lhs[i], &rhs[i], 
               msh->LocalNx , msh->LocalNy , msh->LocalNz );
  result.setLocation(rhs.getLocation());
  checkData(result);
  return result;
...
void autogen_Field3D_Field2D_Field3D_plus(  BoutReal * __restrict__ result , const BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int nx , int ny , int nz ){
  for (int x=0;x<nx;++x){
  for (int y=0;y<ny;++y){
  for (int z=0;z<nz;++z){
       result[z+nz*(y+ny*x)] = lhs[y+x*ny] + rhs[z+nz*(y+ny*x)] ;
...
Field3D operator+(const Field2D & lhs,const Field3D & rhs){
  ...
  checkData(lhs);
  checkData(rhs);
  autogen_Field3D_Field2D_Field3D_plus( &result[i], &lhs[i], &rhs[i], 
               msh->LocalNx , msh->LocalNy , msh->LocalNz );
  result.setLocation(rhs.getLocation());
  checkData(result);
  return result;
...
void autogen_Field3D_Field2D_Field3D_minus(  BoutReal * __restrict__ result , const BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int nx , int ny , int nz ){
  for (int x=0;x<nx;++x){
  for (int y=0;y<ny;++y){
  for (int z=0;z<nz;++z){
       result[z+nz*(y+ny*x)] = lhs[y+x*ny] - rhs[z+nz*(y+ny*x)] ;
...
Field3D operator-(const Field2D & lhs,const Field3D & rhs){
  ...
  checkData(lhs);
  checkData(rhs);
  autogen_Field3D_Field2D_Field3D_minus( &result[i], &lhs[i], &rhs[i], 
               msh->LocalNx , msh->LocalNy , msh->LocalNz );
  result.setLocation(rhs.getLocation());
  checkData(result);
  return result;
...
void autogen_Field2D_Field2D_Field2D_mul(  BoutReal * __restrict__ result , const BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int max ){
  for (int i=0;i<max;++i){
    result[i]=lhs [i] *rhs [i] ;
  }
}
...
void autogen_Field2D_Field2D_Field2D_div(  BoutReal * __restrict__ result , const BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int max ){
  for (int i=0;i<max;++i){
    result[i]=lhs [i] /rhs [i] ;
  }
}
...
void autogen_Field2D_Field2D_Field2D_plus(  BoutReal * __restrict__ result , const BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int max ){
  for (int i=0;i<max;++i){
    result[i]=lhs [i] +rhs [i] ;
  }
}
...
void autogen_Field2D_Field2D_Field2D_minus(  BoutReal * __restrict__ result , const BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int max ){
  for (int i=0;i<max;++i){
    result[i]=lhs [i] -rhs [i] ;
  }
}
...
void autogen_Field2D_Field2D_BoutReal_mul(  BoutReal * __restrict__ result , const BoutReal * __restrict__ lhs , const BoutReal rhs ,  int max ){
  for (int i=0;i<max;++i){
    result[i]=lhs [i] *rhs ;
  }
}
...
void autogen_Field2D_Field2D_BoutReal_div(  BoutReal * __restrict__ result , const BoutReal * __restrict__ lhs , const BoutReal rhs ,  int max ){
  for (int i=0;i<max;++i){
    result[i]=lhs [i] /rhs ;
  }
}
...
void autogen_Field2D_Field2D_BoutReal_plus(  BoutReal * __restrict__ result , const BoutReal * __restrict__ lhs , const BoutReal rhs ,  int max ){
  for (int i=0;i<max;++i){
    result[i]=lhs [i] +rhs ;
  }
}
...
void autogen_Field2D_Field2D_BoutReal_minus(  BoutReal * __restrict__ result , const BoutReal * __restrict__ lhs , const BoutReal rhs ,  int max ){
  for (int i=0;i<max;++i){
    result[i]=lhs [i] -rhs ;
  }
}
...
void autogen_Field3D_BoutReal_Field3D_mul(  BoutReal * __restrict__ result , const BoutReal lhs , const BoutReal * __restrict__ rhs ,  int max ){
  for (int i=0;i<max;++i){
    result[i]=lhs *rhs [i] ;
  }
}
...
void autogen_Field3D_BoutReal_Field3D_div(  BoutReal * __restrict__ result , const BoutReal lhs , const BoutReal * __restrict__ rhs ,  int max ){
  for (int i=0;i<max;++i){
    result[i]=lhs /rhs [i] ;
  }
}
...
void autogen_Field3D_BoutReal_Field3D_plus(  BoutReal * __restrict__ result , const BoutReal lhs , const BoutReal * __restrict__ rhs ,  int max ){
  for (int i=0;i<max;++i){
    result[i]=lhs +rhs [i] ;
  }
}
...
void autogen_Field3D_BoutReal_Field3D_minus(  BoutReal * __restrict__ result , const BoutReal lhs , const BoutReal * __restrict__ rhs ,  int max ){
  for (int i=0;i<max;++i){
    result[i]=lhs -rhs [i] ;
  }
}
...
void autogen_Field2D_BoutReal_Field2D_mul(  BoutReal * __restrict__ result , const BoutReal lhs , const BoutReal * __restrict__ rhs ,  int max ){
  for (int i=0;i<max;++i){
    result[i]=lhs *rhs [i] ;
  }
}
...
void autogen_Field2D_BoutReal_Field2D_div(  BoutReal * __restrict__ result , const BoutReal lhs , const BoutReal * __restrict__ rhs ,  int max ){
  for (int i=0;i<max;++i){
    result[i]=lhs /rhs [i] ;
  }
}
...
void autogen_Field2D_BoutReal_Field2D_plus(  BoutReal * __restrict__ result , const BoutReal lhs , const BoutReal * __restrict__ rhs ,  int max ){
  for (int i=0;i<max;++i){
    result[i]=lhs +rhs [i] ;
  }
}
...
void autogen_Field2D_BoutReal_Field2D_minus(  BoutReal * __restrict__ result , const BoutReal lhs , const BoutReal * __restrict__ rhs ,  int max ){
  for (int i=0;i<max;++i){
    result[i]=lhs -rhs [i] ;
  }
}
...
void autogen_Field3D_Field3D_mul(  BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int max ){
  for (int i=0;i<max;++i){
    lhs[i]*=rhs [i] ;
  }
}
...
Field3D & Field3D::operator *= (const Field3D & rhs){
  ...
  if (data.unique()){
    ...
    autogen_Field3D_Field3D_mul(&(*this)[i], &rhs[i], 
               fieldmesh->LocalNx * fieldmesh->LocalNy * fieldmesh->LocalNz );
#if CHECK > 0
...
void autogen_Field3D_Field3D_div(  BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int max ){
  for (int i=0;i<max;++i){
    lhs[i]/=rhs [i] ;
  }
}
...
void autogen_Field3D_Field3D_plus(  BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int max ){
  for (int i=0;i<max;++i){
    lhs[i]+=rhs [i] ;
  }
}
...
void autogen_Field3D_Field3D_minus(  BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int max ){
  for (int i=0;i<max;++i){
    lhs[i]-=rhs [i] ;
  }
}
...
void autogen_Field3D_Field2D_mul(  BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int nx , int ny , int nz ){
  for (int x=0;x<nx;++x){
  for (int y=0;y<ny;++y){
  for (int z=0;z<nz;++z){
...
Field3D & Field3D::operator *= (const Field2D & rhs){
  ...
  if (data.unique()){
    ...
    checkData(*this);
    checkData(rhs);
    autogen_Field3D_Field2D_mul(&(*this)[i], &rhs[i], 
               fieldmesh->LocalNx , fieldmesh->LocalNy , fieldmesh->LocalNz );
    checkData(*this);
  } else {
    (*this)= (*this) * rhs;
...
void autogen_Field3D_Field2D_div(  BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int nx , int ny , int nz ){
  for (int x=0;x<nx;++x){
  for (int y=0;y<ny;++y){
  for (int z=0;z<nz;++z){
       lhs[z+nz*(y+ny*x)] /= rhs[y+x*ny] ;
...
Field3D & Field3D::operator /= (const Field2D & rhs){
  ...
  if (data.unique()){
    ...
    checkData(*this);
    checkData(rhs);
    autogen_Field3D_Field2D_div(&(*this)[i], &rhs[i], 
               fieldmesh->LocalNx , fieldmesh->LocalNy , fieldmesh->LocalNz );
    checkData(*this);
  } else {
    (*this)= (*this) / rhs;
...
void autogen_Field3D_Field2D_plus(  BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int nx , int ny , int nz ){
  for (int x=0;x<nx;++x){
  for (int y=0;y<ny;++y){
  for (int z=0;z<nz;++z){
       lhs[z+nz*(y+ny*x)] += rhs[y+x*ny] ;
...
Field3D & Field3D::operator += (const Field2D & rhs){
  ...
  if (data.unique()){
    ...
    checkData(*this);
    checkData(rhs);
    autogen_Field3D_Field2D_plus(&(*this)[i], &rhs[i], 
               fieldmesh->LocalNx , fieldmesh->LocalNy , fieldmesh->LocalNz );
    checkData(*this);
  } else {
    (*this)= (*this) + rhs;
...
void autogen_Field3D_Field2D_minus(  BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int nx , int ny , int nz ){
  for (int x=0;x<nx;++x){
  for (int y=0;y<ny;++y){
  for (int z=0;z<nz;++z){
       lhs[z+nz*(y+ny*x)] -= rhs[y+x*ny] ;
...
Field3D & Field3D::operator -= (const Field2D & rhs){
  ...
  if (data.unique()){
    ...
    checkData(*this);
    checkData(rhs);
    autogen_Field3D_Field2D_minus(&(*this)[i], &rhs[i], 
               fieldmesh->LocalNx , fieldmesh->LocalNy , fieldmesh->LocalNz );
    checkData(*this);
  } else {
    (*this)= (*this) - rhs;
...
void autogen_Field3D_BoutReal_mul(  BoutReal * __restrict__ lhs , const BoutReal rhs ,  int max ){
  for (int i=0;i<max;++i){
    lhs[i]*=rhs ;
  }
}
...
Field3D & Field3D::operator *= (BoutReal rhs){
  ...
  if (data.unique()){
    ...
    checkData(*this);
    checkData(rhs);
    autogen_Field3D_BoutReal_mul(&(*this)[i], rhs, 
               fieldmesh->LocalNx * fieldmesh->LocalNy * fieldmesh->LocalNz );
    checkData(*this);
  } else {
    (*this)= (*this) * rhs;
...
void autogen_Field3D_BoutReal_div(  BoutReal * __restrict__ lhs , const BoutReal rhs ,  int max ){
  for (int i=0;i<max;++i){
    lhs[i]/=rhs ;
  }
}
...
Field3D & Field3D::operator /= (BoutReal rhs){
  ...
  if (data.unique()){
    ...
    checkData(*this);
    checkData(rhs);
    autogen_Field3D_BoutReal_div(&(*this)[i], rhs, 
               fieldmesh->LocalNx * fieldmesh->LocalNy * fieldmesh->LocalNz );
    checkData(*this);
  } else {
    (*this)= (*this) / rhs;
...
void autogen_Field3D_BoutReal_plus(  BoutReal * __restrict__ lhs , const BoutReal rhs ,  int max ){
  for (int i=0;i<max;++i){
    lhs[i]+=rhs ;
  }
}
...
Field3D & Field3D::operator += (BoutReal rhs){
  ...
  if (data.unique()){
    ...
    checkData(*this);
    checkData(rhs);
    autogen_Field3D_BoutReal_plus(&(*this)[i], rhs, 
               fieldmesh->LocalNx * fieldmesh->LocalNy * fieldmesh->LocalNz );
    checkData(*this);
  } else {
    (*this)= (*this) + rhs;
...
void autogen_Field3D_BoutReal_minus(  BoutReal * __restrict__ lhs , const BoutReal rhs ,  int max ){
  for (int i=0;i<max;++i){
    lhs[i]-=rhs ;
  }
}
...
Field3D & Field3D::operator -= (BoutReal rhs){
  ...
  if (data.unique()){
    ...
    checkData(*this);
    checkData(rhs);
    autogen_Field3D_BoutReal_minus(&(*this)[i], rhs, 
               fieldmesh->LocalNx * fieldmesh->LocalNy * fieldmesh->LocalNz );
    checkData(*this);
  } else {
    (*this)= (*this) - rhs;
...
void autogen_Field2D_Field2D_mul(  BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int max ){
  for (int i=0;i<max;++i){
    lhs[i]*=rhs [i] ;
  }
}
...
void autogen_Field2D_Field2D_div(  BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int max ){
  for (int i=0;i<max;++i){
    lhs[i]/=rhs [i] ;
  }
}
...
void autogen_Field2D_Field2D_plus(  BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int max ){
  for (int i=0;i<max;++i){
    lhs[i]+=rhs [i] ;
  }
}
...
void autogen_Field2D_Field2D_minus(  BoutReal * __restrict__ lhs , const BoutReal * __restrict__ rhs ,  int max ){
  for (int i=0;i<max;++i){
    lhs[i]-=rhs [i] ;
  }
}
...
void autogen_Field2D_BoutReal_mul(  BoutReal * __restrict__ lhs , const BoutReal rhs ,  int max ){
  for (int i=0;i<max;++i){
    lhs[i]*=rhs ;
  }
}
...
void autogen_Field2D_BoutReal_div(  BoutReal * __restrict__ lhs , const BoutReal rhs ,  int max ){
  for (int i=0;i<max;++i){
    lhs[i]/=rhs ;
  }
}
...
void autogen_Field2D_BoutReal_plus(  BoutReal * __restrict__ lhs , const BoutReal rhs ,  int max ){
  for (int i=0;i<max;++i){
    lhs[i]+=rhs ;
  }
}
...
void autogen_Field2D_BoutReal_minus(  BoutReal * __restrict__ lhs , const BoutReal rhs ,  int max ){
  for (int i=0;i<max;++i){
    lhs[i]-=rhs ;
  }
}
