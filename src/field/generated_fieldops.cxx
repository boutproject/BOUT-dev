...
Field3D operator*(const Field3D &lhs, const Field3D &rhs) {
  ...
  if (lhs.getLocation() != rhs.getLocation()) {
    throw BoutException("Error in operator*(Field3D, Field3D): fields at "
                        "different locations. lhs is at %s, rhs is at %s!",
                        strLocation(lhs.getLocation()),
...
Field3D &Field3D::operator*=(const Field3D &rhs) {
  ...
  if (data.unique()) {
    ...
    if (this->getLocation() != rhs.getLocation()) {
      throw BoutException("Error in Field3D::operator*=(Field3D): fields at "
                          "different locations. lhs is at %s, rhs is at %s!",
...
#if CHECK > 0
  if (lhs.getLocation() != rhs.getLocation()) {
    throw BoutException("Error in operator*(Field3D, Field2D): fields at "
                        "different locations. lhs is at %s, rhs is at %s!",
                        strLocation(lhs.getLocation()),
                        strLocation(rhs.getLocation()));
  }
...
#if CHECK > 0
    if (this->getLocation() != rhs.getLocation()) {
      throw BoutException("Error in Field3D::operator*=(Field2D): fields at "
                          "different locations. lhs is at %s, rhs is at %s!",
                          strLocation(this->getLocation()),
                          strLocation(rhs.getLocation()));
    }
...
#if CHECK > 0
  if (lhs.getLocation() != rhs.getLocation()) {
    throw BoutException("Error in operator*(Field2D, Field3D): fields at "
                        "different locations. lhs is at %s, rhs is at %s!",
                        strLocation(lhs.getLocation()),
                        strLocation(rhs.getLocation()));
  }
...
#if CHECK > 0
  if (lhs.getLocation() != rhs.getLocation()) {
    throw BoutException("Error in operator*(Field2D, Field2D): fields at "
                        "different locations. lhs is at %s, rhs is at %s!",
                        strLocation(lhs.getLocation()),
                        strLocation(rhs.getLocation()));
  }
...
#if CHECK > 0
    if (this->getLocation() != rhs.getLocation()) {
      throw BoutException("Error in Field2D::operator*=(Field2D): fields at "
                          "different locations. lhs is at %s, rhs is at %s!",
                          strLocation(this->getLocation()),
                          strLocation(rhs.getLocation()));
    }
