...
Field3D operator*(const Field3D& lhs, const Field3D& rhs) {
  ...
  if (lhs.getLocation() != rhs.getLocation()) {
    throw BoutException(
        "Error in operator*(Field3D, Field3D): fields at different locations. lhs is at %s, rhs is at %s!",
...
Field3D &Field3D::operator*=(const Field3D& rhs) {
  ...
  if (data.unique()) {
    ...
    if (this->getLocation() != rhs.getLocation()) {
      throw BoutException(
        "Error in Field3D::operator*=(Field3D): fields at different locations. lhs is at %s, rhs is at %s!",
...
Field3D operator*(const Field3D& lhs, const Field2D& rhs) {
  ...
  checkData(rhs);
	...
	const int jz_max = localmesh->LocalNz;
	           _Pragma("ivdep")
	   for (int jz = 0; jz < jz_max; ++jz){
...
Field3D &Field3D::operator*=(const Field2D& rhs) {
  ...
  if (data.unique()) {
	...
	const int jz_max = fieldmesh->LocalNz;
	           _Pragma("ivdep")
           for (int jz = 0; jz < jz_max; ++jz){
