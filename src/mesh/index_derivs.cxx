...
/// fast)
/// Returns DIFF_METHOD, rather than function so can be applied to central and upwind
/// tables
...
const Field3D Mesh::indexVDDX(const Field &v, const Field &f, CELL_LOC outloc,
                              DIFF_METHOD method) {
...
// general case
const Field3D Mesh::indexVDDY(const Field &v, const Field &f, CELL_LOC outloc,
                              DIFF_METHOD method) {
