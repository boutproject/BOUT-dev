...
public:
  ...
  void standard(const T& var, T& result, const std::string& region) const {
    ...
    ASSERT2(region == "RGN_ALL" || region == "RGN_NOBNDRY" || region == "RGN_NOX"
            || region == "RGN_NOY" || region == "RGN_INNER_X" || region == "RGN_OUTER_X"
            || region == "RGN_LOWER_INNER_Y" || region == "RGN_UPPER_INNER_Y"
            || region == "RGN_LOWER_OUTER_Y" || region == "RGN_UPPER_OUTER_Y"
            || region == "RGN_LOWER_Y" || region == "RGN_UPPER_Y" || region == "RGN_BNDRY"
            || region == "RGN_WITH_XBNDRIES" || region == "RGN_WITH_YBNDRIES"
