...
const Field3D indexFDDX_non_stag(const Field3D &v, const Field3D &f, CELL_LOC outloc,
  ...
  case DIFF_NND:
    if (v.getLocation() == f.getLocation()) {
      return interp_to(indexFDDX_norm_DIFF_NND(v, f), outloc);
    } else {
      return interp_to(
          indexFDDX_norm_DIFF_NND(interp_to(v, CELL_CENTRE), interp_to(f, CELL_CENTRE)),
          outloc);
    }
    break;
  default:
...
const Field3D indexFDDY_non_stag(const Field3D &v, const Field3D &f, CELL_LOC outloc,
  ...
  case DIFF_NND:
    if (v.getLocation() == f.getLocation()) {
      return interp_to(indexFDDY_norm_DIFF_NND(v, f), outloc);
    } else {
      return interp_to(
          indexFDDY_norm_DIFF_NND(interp_to(v, CELL_CENTRE), interp_to(f, CELL_CENTRE)),
          outloc);
    }
    break;
  default:
...
const Field3D indexFDDZ_non_stag(const Field3D &v, const Field3D &f, CELL_LOC outloc,
  ...
  case DIFF_NND:
    if (v.getLocation() == f.getLocation()) {
      return interp_to(indexFDDZ_norm_DIFF_NND(v, f), outloc);
    } else {
      return interp_to(
          indexFDDZ_norm_DIFF_NND(interp_to(v, CELL_CENTRE), interp_to(f, CELL_CENTRE)),
          outloc);
    }
    break;
  default:
...
// This file is auto-generated - do not edit!
const Field3D AiolosMesh::indexDDX(const Field3D &f, CELL_LOC outloc,
                                   DIFF_METHOD method) {
  if (outloc == CELL_DEFAULT) {
    outloc = f.getLocation();
  }
...
// This file is auto-generated - do not edit!
const Field3D AiolosMesh::indexDDY(const Field3D &f, CELL_LOC outloc,
                                   DIFF_METHOD method) {
  if (outloc == CELL_DEFAULT) {
    outloc = f.getLocation();
  }
...
// This file is auto-generated - do not edit!
const Field2D AiolosMesh::indexDDX(const Field2D &f) {
...
// This file is auto-generated - do not edit!
const Field2D AiolosMesh::indexDDY(const Field2D &f) {
  CELL_LOC outloc = CELL_DEFAULT;
  DIFF_METHOD method = DIFF_DEFAULT;
  if (outloc == CELL_DEFAULT) {
    outloc = f.getLocation();
...
const Field3D AiolosMesh::indexD2DZ2(const Field3D &f, CELL_LOC outloc,
                                     DIFF_METHOD method, bool ignored) {
  if (outloc == CELL_DEFAULT) {
    outloc = f.getLocation();
  }
  if ((outloc == CELL_ZLOW) != (f.getLocation() == CELL_ZLOW)) {
...
// This file is auto-generated - do not edit!
const Field2D AiolosMesh::indexD2DX2(const Field2D &f) {
  CELL_LOC outloc = CELL_DEFAULT;
  DIFF_METHOD method = DIFF_DEFAULT;
  if (outloc == CELL_DEFAULT) {
    outloc = f.getLocation();
...
// This file is auto-generated - do not edit!
const Field2D AiolosMesh::indexD2DY2(const Field2D &f) {
  CELL_LOC outloc = CELL_DEFAULT;
  DIFF_METHOD method = DIFF_DEFAULT;
  if (outloc == CELL_DEFAULT) {
    outloc = f.getLocation();
