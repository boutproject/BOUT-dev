...
virtual const Field3D indexVDDX(const Field3D &v, const Field3D &f, CELL_LOC outloc,
                                DIFF_METHOD method);
virtual const Field3D indexVDDX(const Field &v, const Field &f, CELL_LOC outloc,
                                DIFF_METHOD method) override {
  return indexVDDX(dynamic_cast<const Field3D &>(v), dynamic_cast<const Field3D &>(f),
                   outloc, method);
}
virtual const Field3D indexVDDY(const Field3D &v, const Field3D &f, CELL_LOC outloc,
                                DIFF_METHOD method);
virtual const Field3D indexVDDY(const Field &v, const Field &f, CELL_LOC outloc,
                                DIFF_METHOD method) override {
  return indexVDDY(dynamic_cast<const Field3D &>(v), dynamic_cast<const Field3D &>(f),
                   outloc, method);
}
