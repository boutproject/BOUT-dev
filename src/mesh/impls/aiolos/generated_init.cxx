...
void AiolosMesh::derivs_init(Options *option) {
  std::string name;
  Options *dirOption;
  output_info.write("\tSetting derivatives for direction x:\n");
  ...
  if (strcasecmp(name.c_str(), "C2") == 0) {
    ...
    output_info.write("	      FirstStag : Second order central\n");
  } else if (strcasecmp(name.c_str(), "C4") == 0) {
    default_x_FirstStagDeriv = DIFF_C4;
    output_info.write("	      FirstStag : Fourth order central\n");
  } else {
  ...
  if (strcasecmp(name.c_str(), "C2") == 0) {
    ...
    output_info.write("	         Second : Second order central\n");
  } else if (strcasecmp(name.c_str(), "C4") == 0) {
    default_x_SecondDeriv = DIFF_C4;
    output_info.write("	         Second : Fourth order central\n");
  } else {
  ...
  if (strcasecmp(name.c_str(), "C2") == 0) {
    ...
    output_info.write("	     SecondStag : Second order central\n");
  } else {
  ...
  if (strcasecmp(name.c_str(), "U1") == 0) {
    ...
    output_info.write("	         Upwind : Fourth order central\n");
  } else {
  ...
  if (strcasecmp(name.c_str(), "U1") == 0) {
    ...
    output_info.write("	     UpwindStag : First order upwinding\n");
  } else if (strcasecmp(name.c_str(), "U2") == 0) {
    default_x_UpwindStagDeriv = DIFF_U2;
    output_info.write("	     UpwindStag : Second order upwinding\n");
  } else if (strcasecmp(name.c_str(), "C2") == 0) {
    default_x_UpwindStagDeriv = DIFF_C2;
    output_info.write("	     UpwindStag : Second order central\n");
  } else if (strcasecmp(name.c_str(), "C4") == 0) {
    default_x_UpwindStagDeriv = DIFF_C4;
    output_info.write("	     UpwindStag : Fourth order central\n");
  } else {
  ...
  if (strcasecmp(name.c_str(), "U1") == 0) {
    ...
    output_info.write("	           Flux : First order upwinding\n");
  } else if (strcasecmp(name.c_str(), "C2") == 0) {
    default_x_FluxDeriv = DIFF_C2;
    output_info.write("	           Flux : Second order central\n");
  } else if (strcasecmp(name.c_str(), "C4") == 0) {
    default_x_FluxDeriv = DIFF_C4;
    output_info.write("	           Flux : Fourth order central\n");
  } else {
  ...
  if (strcasecmp(name.c_str(), "U1") == 0) {
    ...
    output_info.write("	       FluxStag : First order upwinding\n");
  } else {
    throw BoutException("Dont't know what diff method to use for FluxStag (direction x, "
                        "tried to use %s)!\nOptions are:\n * U1: First order upwinding",
                        name.c_str());
  }
  output_info.write("\tSetting derivatives for direction y:\n");
  ...
  output_info.write("\tSetting derivatives for direction z:\n");
