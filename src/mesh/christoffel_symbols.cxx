...
ChristoffelSymbols::ChristoffelSymbols(const Coordinates& coordinates) {
  ...
  G2_13_m =
      // 0.5 *g21*(DDZ(g_11) + DDX(covariantMetricTensor.Getg13()) - DDX(g_13))
      // which equals
      0.5 * g12 * (DDZ(g_11) + DDX(g_13) - DDX(g_13))
      // + 0.5 *g22*(DDZ(covariantMetricTensor.Getg21()) + DDX(g_23) - DDY(g_13))
      // which equals
      + 0.5 * g22 * (DDZ(g_12) + DDX(g_23) - DDY(g_13))
      // + 0.5 *g23*(DDZ(covariantMetricTensor.Getg31()) + DDX(g_33) - DDZ(g_13));
      // which equals
      + 0.5 * g23 * DDX(g_33);
  ...
  G3_33_m = g13 * (DDZ(g_13) - 0.5 * DDX(g_33)) + g23 * (DDZ(g_23) - 0.5 * DDY(g_33))
            + 0.5 * g33 * DDZ(g_33);
  G3_12_m =
      // 0.5 *g31*(DDY(g_11) + DDX(covariantMetricTensor.Getg12()) - DDX(g_12))
      // which equals to
      0.5 * g13 * DDY(g_11)
      // + 0.5 *g32*(DDY(covariantMetricTensor.Getg21()) + DDX(g_22) - DDY(g_12))
      // which equals to
      + 0.5 * g23 * DDX(g_22)
      //+ 0.5 *g33*(DDY(covariantMetricTensor.Getg31()) + DDX(covariantMetricTensor.Getg32()) - DDZ(g_12));
      // which equals to
