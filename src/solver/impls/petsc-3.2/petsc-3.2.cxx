...
int Petsc32Solver::init(rhsfunc f, int argc, char **argv, bool restarting, int NOUT, BoutReal TIMESTEP)
{
  PetscErrorCode  ierr;
  int             neq;
...
void Petsc32Solver::loop_vars_op(int jx, int jy, BoutReal *udata, int &p, SOLVER_VAR_OP op)
{
  BoutReal **d2d, ***d3d;
  unsigned int i;
  int jz;
...
void Petsc32Solver::loop_vars(BoutReal *udata, SOLVER_VAR_OP op)
{
  int jx, jy;
...
void Petsc32Solver::load_vars(BoutReal *udata)
{
  unsigned int i;
...
int Petsc32Solver::save_vars(BoutReal *udata)
{
  unsigned int i;
...
void Petsc32Solver::save_derivs(BoutReal *dudata)
{
  unsigned int i;
