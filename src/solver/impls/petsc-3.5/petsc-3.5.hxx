...
extern PetscErrorCode solver_ijacobian(TS,PetscReal,Vec,Vec,PetscReal,Mat,Mat,void*); //Why is this here but solver_ijacobianfd and solver_rhsjacobian are in *.cxx?
