...
installed, this points to the IDL install (e.g. something like \file{/usr/common/usg/idl/idl70/bin/install} on Franklin). A quick way to fix this is to create a link from your local bin to the system install:
\begin{verbatim}
...
This example is taken from the UEDGE benchmark test (in \file{examples/uedge-benchmark}):
\begin{lstlisting}[language=bash,numbers=none]
[All]
