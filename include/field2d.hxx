...
inline Field2D toFieldAligned(const Field2D& f, const REGION UNUSED(region) = RGN_ALL) {
  return f;
}
inline Field2D fromFieldAligned(const Field2D& f, const REGION UNUSED(region) = RGN_ALL) {
  return f;
}
