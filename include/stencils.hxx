...
class bvalue {
 public:
  ...
  bvalue & operator*=(const BoutReal rhs); ///< Multiply by rhs val  
  bvalue & operator/=(const bvalue &rhs);  ///< Divide by rhs val. Doesn't check or modify indices
  bvalue & operator/=(const BoutReal rhs); ///< Divide by rhs val
  ...
  const bvalue operator*(const BoutReal rhs) const;  ///< Multiply by value 
  const bvalue operator/(const bvalue &other) const; ///< Divide bvalues. Index is taken from the left operand
  const bvalue operator/(const BoutReal rhs) const; ///< Divide by value 
};

const bvalue operator*(const BoutReal lhs, const bvalue &rhs); ///< Multiply a constant by a bvalue
const bvalue operator/(const BoutReal lhs, const bvalue &rhs); ///< Divide a constant by a bvalue
