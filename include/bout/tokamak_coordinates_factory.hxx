...
public:
  ...
  TokamakCoordinatesFactory(Mesh& mesh, const Field2D& Rxy, const Field2D& Bpxy, const Field2D& Btxy, const FieldMetric& B)
      : mesh_m(mesh), Rxy_m(Rxy), Bpxy_m(Bpxy), Btxy_m(Btxy), B_m(B) {}
