...
/// Div ( a Grad_perp(f) )
///
/// This version uses pre-computed coefficient.  They are generated by
/// zoidberg during grid generation.

/// @param[in]  a            The diffusion coefficient
/// @param[in]  f            The field to diffuse
/// @param[out] flow_xlow    Flow at the lower X cell boundary
///                          Already includes area factor * flux
///                          This field is optional
/// @param[out] flow_zlow    Flow at the lower Z cell boundary
///                          Already includes area factor * flux
///                          This field is optional
