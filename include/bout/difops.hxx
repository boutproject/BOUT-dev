...
Field3D Div_par_flux(const Field3DParallel& v, const Field3DParallel& f, CELL_LOC outloc = CELL_DEFAULT,
                     const std::string& method = "DEFAULT");

inline Field3D Div_par_flux(const Field3DParallel& v, const Field3DParallel& f, CELL_LOC outloc,
                            DIFF_METHOD method) {
