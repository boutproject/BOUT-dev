...
public:
  ...
  static Interpolation *CreateHermiteSpline() { return new HermiteSpline; }
...
public:
  ...
  /// Callback function for InterpolationFactory
  static Interpolation *CreateLagrange4pt() { return new Lagrange4pt; }
...
public:
  ...
  Bilinear(BoutMask mask, int y_offset = 0) : Bilinear(y_offset) { skip_mask = mask; }
  ...
  /// Callback function for InterpolationFactory
  static Interpolation *CreateBilinear() { return new Bilinear; }
