...
const Vector3D DDX(const Vector3D &v, CELL_LOC outloc = CELL_DEFAULT, DIFF_METHOD method = DIFF_DEFAULT);
const Vector3D DDX(const Vector3D &v, DIFF_METHOD method, CELL_LOC outloc = CELL_DEFAULT);
...
const Vector3D DDY(const Vector3D &v, CELL_LOC outloc = CELL_DEFAULT, DIFF_METHOD method = DIFF_DEFAULT);
const Vector3D DDY(const Vector3D &v, DIFF_METHOD method, CELL_LOC outloc = CELL_DEFAULT);
