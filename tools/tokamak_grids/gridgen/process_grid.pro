...
;       H[xi, yi] = H[xi, yi] - H[xi,yi[0]]
  ...
  IF NOT KEYWORD_SET(curv) THEN BEGIN
    ...
    curvature, nx, ny, DOUBLE(Rxy), DOUBLE(Zxy), DOUBLE(brxy), DOUBLE(bzxy), DOUBLE(btxy), $
