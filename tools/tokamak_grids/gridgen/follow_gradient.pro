...
FUNCTION radial_differential, fcur, pos
  COMMON rd_com, idata, lastgoodf, lastgoodpos, R, Z, ood, boundary, ri0, zi0, tol, vec, weightc, bndry_periodic
...
PRO follow_gradient, interp_data, R, Z, ri0, zi0, ftarget, ri, zi, status=status, $
  ...
  COMMON rd_com, idata, lastgoodf, lastgoodpos, Rpos, Zpos, ood, bndry, ri0c, zi0c, tol, vec_comm, weightc, bndry_periodic
