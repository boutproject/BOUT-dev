...
if(BOUT_HAS_CUDA)
  ...
  # NOTE: CUDA inherits the CXX standard setting from the top-level compile
  # features, set for the bout++ target.
...
if(BOUT_USE_SYSTEM_MPARK_VARIANT)
  ...
  get_target_property(MPARK_VARIANT_INCLUDE_PATH mpark_variant
...
if(BOUT_USE_SYSTEM_FMT)
  ...
  # Build the library in <build dir>/lib: this makes updating the path for
  # bout-config much easier
...
if(BOUT_USE_PVODE)
  ...
  # Build the libraries in <build dir>/lib: this makes updating the path for
  # bout-config much easier
  set_target_properties(
    pvode pvpre
...
if(BOUT_USE_SYSTEM_CPPTRACE)
  ...
  get_target_property(CPPTRACE_INCLUDE_PATH cpptrace::cpptrace
                      INTERFACE_INCLUDE_DIRECTORIES)
else()
