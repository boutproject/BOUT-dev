...
function(target_enable_cxx_warning_if_supported TARGET)
  ...
  foreach(WARNING_FLAG IN LISTS TARGET_ENABLE_WARNING_FLAGS)
    ...
    # Note that gcc ignores unknown flags of the form "-Wno-warning" for
    # backwards compatibility. Therefore we need to add the positive form as an
    # additional flag which it will choke on (if it doesn't exist). See:
    ...
    if(HAS_FLAG_${WARNING_FLAG_STRIPPED})
      ...
      target_compile_options(
        ${TARGET}
        PRIVATE $<$<NOT:$<COMPILE_LANGUAGE:CUDA>>:${WARNING_FLAG} >
