...
# ------------
#
# Find SUNDIALS, the SUite of Nonlinear and DIfferential/ALgebraic equation
# Solvers
#
# Currently only actually looks for arkode, cvode and ida, as well as
# nvecparallel
#
...
# SUNDIALS_INCLUDE_DIRS - Location of the SUNDIALS includes SUNDIALS_LIBRARIES -
# Required libraries SUNDIALS_VERSION      - Full version string
#
# This module will export the following targets:
#
# ``SUNDIALS::NVecParallel`` ``SUNDIALS::arkode`` ``SUNDIALS::cvode``
# ``SUNDIALS::ida``
#
# You can also set the following variables:
#
# ``SUNDIALS_ROOT`` or ``SUNDIALS_DIR`` (as an environment variable) Specify the
# path to the SUNDIALS installation to use
#
# ``SUNDIALS_DEBUG`` Set to TRUE to get extra debugging output
