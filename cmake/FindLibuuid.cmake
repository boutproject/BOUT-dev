...
# ::
#
# Libuuid_FOUND - true if Libuuid was found Libuuid_INCLUDE_DIRS - Location of
# the Libuuid includes Libuuid_LIBRARIES - Required libraries
#
# This module will also export the ``Libuuid::libuuid`` target.
#
# You can also set the following variables:
#
# ``Libuuid_ROOT`` Specify the path to the Libuuid installation to use
#
# ``Libuuid_DEBUG`` Set to TRUE to get extra debugging output
...
if(APPLE)
  ...
  if(Libuuid_FOUND AND NOT TARGET Libuuid::libuuid)
    ...
    set_target_properties(Libuuid::libuuid PROPERTIES IMPORTED_LOCATION
                                                      ${CFLIB})
  endif()
  return()
endif()
...
if(Libuuid_FOUND AND NOT TARGET Libuuid::libuuid)
  ...
  set_target_properties(
    Libuuid::libuuid
    PROPERTIES IMPORTED_LOCATION "${Libuuid_LIBRARIES}"
