...
find_path(
  HYPRE_INCLUDE_DIR
  NAMES HYPRE.h
  DOC "HYPRE include directories" REQUIRED
...
if(HYPRE_INCLUDE_DIR)
  ...
  string(
    REGEX MATCH
          ".*#define HYPRE_RELEASE_VERSION \"([0-9]+)\\.([0-9]+)\\.([0-9]+)\".*"
          _ "${HYPRE_CONFIG_FILE}"
  )
  ...
  set(HYPRE_VERSION
      "${HYPRE_VERSION_MAJOR}.${HYPRE_VERSION_MINOR}.${HYPRE_VERSION_PATCH}"
  )
endif()
...
if(HYPRE_FOUND AND NOT TARGET HYPRE::HYPRE)
  ...
  set_target_properties(
    HYPRE::HYPRE
    PROPERTIES IMPORTED_LOCATION "${HYPRE_LIBRARY}"
