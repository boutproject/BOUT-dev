# Note: Currently BOUT++ always needs MPI. This option just determines whether
# the find_* routines are used
option(BOUT_ENABLE_MPI "Enable MPI support" ON)
if(BOUT_ENABLE_MPI)
  # This might not be entirely sensible, but helps CMake to find the correct
  # MPI, workaround for https://gitlab.kitware.com/cmake/cmake/issues/18895
...
set_property(CACHE BOUT_OPENMP_SCHEDULE PROPERTY STRINGS static dynamic guided
                                                 auto)
...
if(BOUT_ENABLE_CUDA)
  ...
  if(BOUT_ENABLE_OPENMP)
    # CMAKE_CUDA_FLAGS does not pass OpenMP_CXX_FLAGS to the host compiler by
    # default
