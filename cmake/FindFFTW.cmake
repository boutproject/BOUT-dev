...
#
# This module uses the ``fftw-wisdom`` executable as a hint for the location of
# the FFTW library. It should be in your PATH.
#
# This module will define the following variables:
#
# ::
#
# FFTW_FOUND - true if FFTW was found FFTW_INCLUDE_DIRS - Location of the FFTW
# includes FFTW_LIBRARIES - Required libraries
#
# This module will also export the ``FFTW::FFTW`` target.
#
# You can also set the following variables:
#
# ``FFTW_ROOT`` Specify the path to the FFTW installation to use
#
# ``FFTW_DEBUG`` Set to TRUE to get extra debugging output
...
if(EXISTS ${FFTW_ROOT})
  ...
  set(FFTW_ROOT
      ""
      CACHE FILEPATH "Location of the FFTW library")
endif()
...
find_program(FFTW_WISDOM "fftw-wisdom" DOC "Path to fftw-wisdom executable")
if(FFTW_DEBUG)
...
if(FFTW_FOUND AND NOT TARGET FFTW::FFTW)
  ...
  set_target_properties(
    FFTW::FFTW PROPERTIES IMPORTED_LOCATION "${FFTW_LIBRARIES}"
