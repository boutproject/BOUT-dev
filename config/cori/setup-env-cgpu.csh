...
#usage: ./setup-cori-cgpu.csh [path to spack]
#example: source ./scripts-config/cori-examples/setup-cori-cgpu.csh /global/project/projectdirs/bout/BOUT-GPU/spack/share/spack/modules/cray-cnl7-skylake_avx512
module purge
...
setenv SPACK_ROOT /global/project/projectdirs/bout/BOUT-GPU/spack
...
set cxx = /usr/common/software/sles15_cgpu/gcc/8.3.0/bin/g++
set CC = /usr/common/software/sles15_cgpu/gcc/8.3.0/bin/g++
set f77 = /usr/common/software/sles15_cgpu/gcc/8.3.0/bin/gfortran
set fc = /usr/common/software/sles15_cgpu/gcc/8.3.0/bin/gfortran
set ftn = /usr/common/software/sles15_cgpu/gcc/8.3.0/bin/gfortran
