/*
 * Testing performance of two approaches to offsetting
 *
 */
...
int main(int argc, char **argv) {
  ...
  ITERATOR_TEST_BLOCK(
      ...
      BLOCK_REGION_LOOP_SERIAL(mesh->getRegion("RGN_NOBNDRY"), i,
                               s.c = a[i];
                               s.p = a[offset.zp(i)];
                               s.m = a[offset.zm(i)];
                               s.pp = a[offset.zpp(i)];
  ...
  ITERATOR_TEST_BLOCK("Region (omp)",
		      BLOCK_REGION_LOOP(mesh->getRegion("RGN_NOBNDRY"), i,
                               s.c = a[i];
                               s.p = a[offset.zp(i)];
                               s.m = a[offset.zm(i)];
                               s.pp = a[offset.zpp(i)];
